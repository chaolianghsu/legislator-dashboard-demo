...
export const descriptionConfigs = {
  ...
  互動強度:
    '在社群、討論區、部落格中，平均每篇文章有多少留言數，數值越高表示互動強度越高。',
  粉絲觸及力: '估計粉專經常互動的人數。',
  社群互動力: '按讚數、留言數及分享數的加總，數值越高表示互動程度越高。',
  平均互動力: '平均每位經常互動者會有多少互動數。',
  八大施政好感度: '近三個月該選區在各項公共議題的網路聲量及網路好感程度。',
  搖擺人數: '該選區輪流投給不同政黨的人數。',
  搖擺選票: '扣除各競爭政黨的鐵票後，剩餘的選票。',
  歷史搖擺程度: '過去四屆該縣市轉投不同政黨的機率。',
  預估投票人數: '該選區20歲以上人數乘以過去四屆平均投票率。',
  '2023選舉人數': '該選區2022年9月20歲以上人數',
  平均投票率: '該選區過去四屆平均投票率。',
  黨最高得票數: '本黨在四次選舉中的最高獲得選票數。',
  黨最低得票數: '本黨在四次選舉中的最低獲得選票數。',
  黨優勢: '在這個地區平均比其他黨多拿到的選票。',
  心佔率:
    '所有相關候選人的網路聲量中提及自己的佔比，百分比越高表示被提及的次數越多。',
  選區競爭: '自己與競爭對手在各項指標的優劣勢情形。',
  選民輪廓: '該選區選民的各項人口統計資料。統計時間：2022年9月。',
  歷史模型: '過去4屆立委選舉結果。',
...
function TitleData({
  ...
  const unitTypesMap = {
    percentage: (
      ...
      >
        {markNumber >= 0 ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
        {' '}
        {markNumber}
        %
      </Typography>
